...
#define MICROPY_HW_CLK_APB1_DIV         (RCC_HCLK_DIV8)
#define MICROPY_HW_CLK_APB2_DIV         (RCC_HCLK_DIV8)
#define MICROPY_HW_CLK_APB3_DIV         (RCC_HCLK_DIV8)
...
#define MBOOT_BOARD_EARLY_INIT(initial_r0)       mboot_early_init()
